...
#     """filter Users table by term into JSON list """
#     term = "%{}%".format(term)  # "ilike" is case insensitive and requires wrapped  %term%
#     table = Users.query.filter((Users.name.ilike(term)) | (Users.number.ilike(term)))
#     return [peep.read() for peep in table]
#
#
# # User extraction from SQL
...
#     """finds User in table matching email """
#     return Users.query.filter_by(number=number).first()
#
#
# """ app route section """
#
...
#     # class for create/post
#     class _Create(Resource):
#         def post(self, number, name, period, teacher):
#             po = Users(number, name, period, teacher)
#             person = po.create()
#             if person:
#                 return person.read()
...
#     # class for update/put
#     class _Update(Resource):
#         def put(self, number, name, period, teacher):
